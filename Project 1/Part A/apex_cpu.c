...
APEX_decode(APEX_CPU *cpu)
{
    ...
    if (cpu->decode.has_insn && (!cpu->decode.stalled))
    {
        ...
        case OPCODE_STR:
        {
            if (cpu->regs_valid[cpu->decode.rs1] && cpu->regs_valid[cpu->decode.rs2] && cpu->regs_valid[cpu->decode.rd])
            {
        ...
        case OPCODE_STORE:
        {
            if (cpu->regs_valid[cpu->decode.rs1] && cpu->regs_valid[cpu->decode.rs2])
            {
                cpu->decode.rs1_value = cpu->regs[cpu->decode.rs1];
                cpu->decode.rs2_value = cpu->regs[cpu->decode.rs2];
        ...
        case OPCODE_LOAD:
        {
            if (cpu->regs_valid[cpu->decode.rs1] && cpu->regs_valid[cpu->decode.rd])
            {
                cpu->decode.rs1_value = cpu->regs[cpu->decode.rs1];
                if (cpu->mem_valid[cpu->decode.rs1_value + cpu->decode.imm])
                {
        ...
        case OPCODE_MOVC:
        {
            ...
            if (cpu->regs_valid[cpu->decode.rd])
            {
            }
            else
            {
...
APEX_execute(APEX_CPU *cpu)
{
    ...
    if (cpu->execute.has_insn)
    {
        ...
        if (ENABLE_DEBUG_MESSAGES && cpu->execute.opcode != OPCODE_NULL)
        {
